...
extern const Transition_Entry gTransitionEntries[] =
{
    ...
    { EVENT_POWER_UP_STATION_FAIL, STATE_WAITING_POWER_UP_STATION, STATE_POWERING_DOWN_STATION, PowerDownStation },
    ...
    // PUBLISH A0 -> PUBLISH BATTERY LEVEL
    { EVENT_PUBLISH_A0_SUCCESS, STATE_WAITING_PUBLISH_SENSOR_DATA_A0, STATE_WAITING_PUBLISH_BATTERY_LEVEL, PublishBatteryLevel },
    ...
    { EVENT_PUBLISH_BATTER_FAIL, STATE_WAITING_PUBLISH_BATTERY_LEVEL, STATE_WAITING_DISCONNECT_MQTT, DisconnectMQTT },
